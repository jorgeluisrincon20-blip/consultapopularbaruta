...
import {
  ...
  ClipboardList, Plus, Trash2, FileDown, Printer, Loader2, Pencil, Save
} from "lucide-react";
...
function SelectPill({ value, onChange, options, placeholder, fullWidth = false }) {
  const T = useT();
  return (
    <div className={`relative ${fullWidth ? "w-full" : ""}`}>
      <select
        ...
        className={`appearance-none text-sm rounded-lg pl-3 pr-8 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all duration-200 ${fullWidth ? "w-full" : ""}`}
...
const SEED_PROYECTOS = [
  {
    ...
    "estado": "SE MODIFICO",
    "parroquia": "PQ. BARUTA",
    "unidad": "CIRCUITO BELLO MONTE LAS MERCEDES PRADOS",
    "tipo": "CIRCUITO ELECTORAL",
    "proyectos": [
      "2T DOTACION DE CILINDROS DE GAS",
      "NUCLEO TECNOLOGICO",
      "DOTACION CDI SALVADOR ALLENDE",
      "CONTINUIDAD PARQUE LAS MERCEDES",
      "CONTINUIDAD REHABILITACION CASA ADULTO MAYOR",
      "TRANSPORTE INTERNO PRADOS DEL ESTE"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "JUNTO VENCEREMOS ( LA TRINIDAD)",
    "tipo": "CIRCUITO ELECTORAL",
    "proyectos": [
      "1T. INSTALAR POTABILIZADORA PARA RECARGAR AGUA",
      "2. RECUPERAR PLACAS EN EDIFICIOS",
      "2. CASETA PARA DESECHOS SOLIDOS",
      "2. REHABILITACION DE MURO PERIMETRAL",
      "2. 40 TANQUES PARA AGUA POTABLE",
      "3. CAMARAS PARA SEGURIDAD CIUDADANA",
      "4. EQUIPOS MEDICOS PARA EL SEGURO SOCIAL, CLINICA POPULAR TIPO I, LA TRINIDAD"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE MODIFICO",
    "parroquia": "PQ. BARUTA",
    "unidad": "INDIO DE BARUTA",
    "tipo": "COMUNA",
    "proyectos": [
      "2T SUSTITUCION DE CILINDROS PH",
      "2T DOTACION DE TANQUES",
      "2T CAMINERIAS Y REDUCTORES DE VELOCIDAD",
      "ELECTRODOMESTICOS",
      "MUROS PERIMETRALES",
      "ALUMBRADO PUBLICO",
      "FACHADAS (REMODELACION Y PINTURA)"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "CON DIOS TODO ES POSIBLE",
    "tipo": "COMUNA",
    "proyectos": [
      "2T SUSTITUCION DE CILNDROS PH",
      "2T CONTINUIDAD DE CAMINERIAS Y PASAMANOS EN TODA LA COMUNA",
      "2T DOTACION DE TANQUES DE AGUA",
      "2T SUSTITUCION DE AGUAS SERVIDAS",
      "PARQUE BIOSALUDABLE",
      "COMPRA DE CASA COMUNAL",
      "1T CONTINUIDAD FINANCIAMIENTOS A PEQUEÑOS EMPRENDEDORES"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "SOCIALISTA SANTA CRUZ",
    "tipo": "COMUNA",
    "proyectos": [
      "1T DISTRIBUCION Y CANALIZACION DE PESCA",
      "2T ADQUISICION DE CILINDROS DE GAS II",
      "2T REHABILITACION DE CAMINERIAS",
      "2T EMBELLICIMIENTO DE FACHADAS",
      "2T ADQUISICION DE TANQUES DE AGUA",
      "2T CANALIZACION DE AGUA PLUVIAL",
      "4T DOTACION DE INSUMOS Y AYUDAS TECNICAS"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "LOS PLACERES DE MARIA",
    "tipo": "COMUNA",
    "proyectos": [
      "2T SUSTITUCION Y ASIGNACION DE CILINDROS",
      "2T ASIGNACION DE LUMINARIAS PARA LA COMUNA",
      "2T COMPRA DE CILINDRO DE AGUA PARA LA COMUNA",
      "2T SUSTITUCION DE TUBERIA DE AGUA PARA LA COMUNA",
      "2T REPARACION DE CAMINERIAS DE TODA LA COMUNA",
      "2T MAQUINARIA DE TUBERIAS DE AGUAS BLANCAS",
      "1T MAQUINARIA PARA TALLER DE SUBLIMACION PARA TODA LA COMUNA"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE MODIFICO",
    "parroquia": "PQ. BARUTA",
    "unidad": "LIVIA GOUVERNEU",
    "tipo": "COMUNA",
    "proyectos": [
      "2T DOTACION DE CILINDROS TANQUE DE AGUA",
      "2T ILUMINACION DE CAMINERIAS",
      "2T DOTACION DE LAMINAS ZINC",
      "2T REPARACION Y REHABILITACION DE CAMINERIAS Y AREAS RECREATIVAS",
      "2T REHABILITACON DE VIVIENDAS (ARREGLOS MENORES)"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "COMUNA 13 DE ABRIL",
    "tipo": "CIRCUITO ELECTORAL",
    "proyectos": [
      "4T CONSTRUCCION DELESPACIO DE ATENCION Y RECREACION DEL ADULTO MAYOR",
      "2T SUSTITUCION DE CILINDROS PH",
      "1T CONTINUIDAD DE FINANCIAMIENTO DE TANQUES PARA ALMACENAMIENTO DE AGUA",
      "2T CONTINUIDAD DE CAMINERIA Y VIALIDAD",
      "2T COMPRA DE ZINC PARA REPARACION DE VIVIENDA",
      "2T CANALIZACION DE AGUAS SERVIDAS",
      "2T CONTINUIDAD DE ALUMBRADO PUBLICO (RENOVACION DE LUMINARIA)"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "JUANA RAMIREZ LA AVANZADORA I",
    "tipo": "CIRCUITO ELECTORAL",
    "proyectos": [
      "2T CAMBIO DE CILINDROS",
      "2T DOTACION DE TANQUES DE AGUA",
      "5T EQUIPAMINETO DE SALA AUTOGOBIERNO Y JUECES DE PAZ",
      "2T ARREGLOS DE CAMINERIAS",
      "2T DOTACION DE ILUMINARIAS",
      "2T ASIGNACION DE LAMINAS DE ZINC",
      "2T CAMBIOS DE TUBERIA A TERMOFUSION"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "HASTA LA VICTORIA POR SIEMPRE I",
    "tipo": "COMUNA",
    "proyectos": [
      "FINANCIAMIENTO DE LINEA BLANCA",
      "PARQUE BIOSALUDABLES EN LA COMUNA",
      "REPARACION DE CAMINERIAS Y ESCALERAS",
      "FINANCIAMIENTOS DE TANQUES DE AGUA",
      "FINANCIAMIENTO DE CILINDROS DE GAS DOMESTICO",
      "ADQUISICION DE ESPACIO PARA CONSULTORIO MEDICO",
      "FINANCIAMIENTOS EMPRENDEDORES DE LA COMUNA"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "VOCES LIBERTARIAS",
    "tipo": "CIRCUITO ELECTORAL",
    "proyectos": [
      "2T ALUMBRADO PUBLICO Y TENDIDO ELECTRICO",
      "CONSTRUCCION DE CASA COMUNAL Y GALPON PARA BLOQUERA",
      "2T SUSTITUCION BOMBONAS PH",
      "CANALIZACION AGUAS LLUVIA",
      "ADQUISICION DE TUBERIAS DE AGUAS SERVIDAS",
      "ADQUISICION DE TANQUES",
  ...
  },
  {
    ...
    "estado": "SE MODIFICO",
    "parroquia": "PQ. BARUTA",
    "unidad": "LAS LOMAS SOCIALISTA",
    "tipo": "COMUNA",
    "proyectos": [
      "1T CRIA DE CABRAS PARA PRODUCCION DE LECHE Y QUESO",
      "2T REHABILITACION DE CAMINERIAS Y VIAS INTERNAS",
      "2T ILUMINACION Y SEÑALIZACION VIA PRINCIPAL",
      "4T DOTACION DE MEDICAMENTOS Y AYUDAS TECNICAS",
      "6T CREACION DE SEMILLERO CIENTIFICO EN LA COMUNA",
      "1T PLAN DE FINANCIAMIENTO DE ELECTRODOMESTICOS",
      "4T PARQUE BIOSALUDABLE PARA LA COMUNA"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "A VIVIR LA LIMONERA",
    "tipo": "COMUNA",
    "proyectos": [
      "4T PINTURA Y TECHADO DE BOMBONAS",
      "2T INFOCENTRO",
      "1T CRIA Y ENGORDE DE POLLO",
      "2T REDUCTORES DE VELOCIDAD Y OJO DE GATO",
      "4T HERRAMIENTAS Y EQUIPOS DE MANTENIMIENTO PARA LAS TORRES",
      "2T ILUMINACION EXTERNA DE LAS TORRES",
      "1T SUBLIMICACION Y ESTAMPADOS"
    ],
    "observacion": ""
  },
  {
    ...
    "tipo": "COMUNA",
    "proyectos": [
      "2T SUSTITUCION DE CILINDROS",
      "2T SUSTITUCION DE TUBERIA DE AGUAS SERVIDAS",
      "2T ALUMBRADO PUBLICO",
      "2T DOTACION DE TANQUES DE AGUA",
      "2T ELECTRIFICACION",
      "FACHADAS",
      "VIALIDAD INTERNA"
  ...
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "LOS OJOS DE CHAVEZ",
    "tipo": "COMUNA",
    "proyectos": [
      "1T TALLER DE COSTURA",
      "2T COMPRA DE CILINDROS",
      "2T CONTINUIDAD DE SUSTITUCION DE TECHOS",
      "2T COMPRA DE TANQUES DE AGUA",
      "2T AGUAS SERVIDAS Y TORRENTERAS",
      "2T CAMINERIAS",
      "2T ALUMBRADO"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. BARUTA",
    "unidad": "HASTA LA VICTORIA POR SIEMPRE",
    "tipo": "COMUNA",
    "proyectos": [
      "2T SUSTITUCION DE BOMBONAS PH",
      "2T CONTINUIDAD DEL BASURERO",
      "2T ALUMBRADO PUBLICO",
      "2T CAMINERIAS",
      "2T CANALIZACION DE AGUAS SERVIDAS",
      "1T CREAR ESPACIOS PARA ESTACIONAMIENTOS DE MOTOS",
  ...
  },
  {
    ...
    "tipo": "CIRCUITO ELECTORAL",
    "proyectos": [
      "1T ESPACIOS PRODUCTIVOS PARA PLANTAS MEDICINALES Y AJO NEGRO",
      "2T EMISORA COMUNITARIA",
      "2T CONSTRUCCION DE LA CASA COMUNAL ADULTO MAYOR URB SAN LUIS",
      "4T RECUPERACION INTEGRAL DEL PARQUE LA FILA URB SAN LUIS",
      "4T MANTENIMIENTO GENERAL DEL CONSULTORIO Y LABORATORIO DENTAL",
      "4T RED ASISTIDA CON LABORATORIO CLINICO",
      "4T EXTENSION DE SERVICIO DE SALUD EN EL CONSEJO COMUNAL"
    ],
    "observacion": ""
  },
  {
    ...
    "unidad": "JUSTICIA E IGUALDAD",
    "tipo": "COMUNA",
    "proyectos": [
      "2T REPARACION DE CAMINERIAS, ESCALERAS Y PASAMANOS",
      "2T SUSTITUCION DE CILINDROS PH",
      "2T CONTINUIDAD DE GAS DIRECTO EN LA COMUNIDAD",
      "2T ADQUISICION DE TANQUES DE AGUA",
      "REHABILITACION Y ASFALTADO DE LA CALLE",
      "DOTACION DE IMPLEMENTOS DEPORTIVOS EL RELLENO Y PS",
      "CREACION DE LA CASA DE LOS ABUELOS"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE MODIFICO",
    "parroquia": "PQ. LAS MINAS DE BARUTA",
    "unidad": "PRIMERA FORTALEZA DEL ROSARIO",
    "tipo": "COMUNA",
    "proyectos": [
      "T1 CONTINUIDAD DEL PROYECTO SOCIOPRODUCTIVO UNIDAD TEXTIL Y GIMNASIO",
      "CONTINUIDAD DE DOTACION DE CILINDROS DE AGUA A LAS FAMILIAS EN LA COMUNA",
      "SEGURIDAD ALUMBRADO PUBLICO, CAMARAS DE VIGILANCIA Y REDUCTORES DE VELOCIDAD",
      "REPARACION Y SUSTITUCION DE TUBERIAS DE AGUA POTABLE",
      "CONTINUIDAD A LA RECUPERACION DE CAMINERIAS EN LA COMUNA",
      "SUSTITUCION DE TUBERIAS DE AGUAS SERVIDAS",
      "CONTINUIDAD DE DOTACION DE CILINDROS DE GAS A LAS FAMILIAS EN LA COMUNA"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE MODIFICO",
    "parroquia": "PQ. LAS MINAS DE BARUTA",
    "unidad": "HUGO CHAVEZ FRIAS",
    "tipo": "COMUNA",
    "proyectos": [
      "2T SUSTITUCIO Y ASIGNACION CILINDROS GAS DOMESTICOS",
      "2T CONTINUACION Y REHABILITACION DE TUBERIAS",
      "2T REHABILITACION DE CAMINERIAS, CALLEJONES Y ESCALERAS",
      "1T COMPRA DE BIENES PARA COMERCIALIZACION",
      "2T COMPRA DE ILUMINARIAS",
      "2T CULMINACION DE LA SEDE CASA DEL AUTOGOBIERNO COMUNAL",
      "1T COMPRA DE EQUIPOS PARA DIFUSION CULTURAL"
    ],
    "observacion": ""
  },
  {
    ...
    "estado": "SE CONFIRMA",
    "parroquia": "PQ. LAS MINAS DE BARUTA",
    "unidad": "FUERZA Y LUCHA POPULAR DEL ROSARIO",
    "tipo": "COMUNA",
    "proyectos": [
      "4T DOTACION Y EQUIPAMIENTO DE CASA COMUNAL Y BASE DE MISIONES FUERZA Y LUCHA",
      "2T SUSTITUCION DE CILINDROS DE GAS PH Y ASIGNACION",
      "REDUCTORES DE VELOCIDAD",
      "2T ARREGLOS DE FACHADAS",
      "2T SUSTITUCION DE TECHOS",
      "2T ARREGLO DE CAMINERIAS",
      "2T ALUMBRADO DE CALLEJONES"
    ],
    "observacion": ""
  }
];

/* ----------------------------- PROYECTOS (COMUNAS / CIRCUITOS) ----------------------------- */

const ESTADOS_PROYECTO = ["POR REVISAR", "SE CONFIRMA", "SE MODIFICO", "PENDIENTE"];
const PROYECTOS_STORAGE_KEY = "baruta:proyectos_postulados_v2";
const NUM_PROYECTOS_SLOTS = 7;

const ESTADO_STYLE = {
  "SE CONFIRMA":  { color: "#34D399", bg: "rgba(16,185,129,0.12)", pdf: "#059669" },
  "SE MODIFICO":  { color: "#FBBF24", bg: "rgba(251,191,36,0.12)", pdf: "#B45309" },
  "PENDIENTE":    { color: "#F87171", bg: "rgba(239,68,68,0.1)", pdf: "#B91C1C" },
  "POR REVISAR":  { color: "#94A3B8", bg: "rgba(148,163,184,0.14)", pdf: "#475569" },
};

function emptyProyectoForm() {
  return {
    estado: "POR REVISAR",
    parroquia: "PQ. BARUTA",
    unidad: "",
    tipo: "",
    responsable: "",
    proyectos: Array.from({ length: NUM_PROYECTOS_SLOTS }, () => ""),
    observacion: "",
  };
}
...
function TabProyectos() {
  ...
  // Cargar datos persistidos (si el entorno soporta window.storage)
  React.useEffect(() => {
    let mounted = true;
    (async () => {
      try {
        if (typeof window !== "undefined" && window.storage) {
          const res = await window.storage.get(PROYECTOS_STORAGE_KEY).catch(() => null);
          if (mounted) {
            if (res && res.value) {
              setItems(JSON.parse(res.value));
            } else {
              // Primera vez: se precargan los proyectos ya postulados (consulta julio 2026)
              const seeded = SEED_PROYECTOS.map((s) => ({
                ...s,
                responsable: s.responsable || "Sala Situacional Baruta",
                historial: [{ fecha: s.fecha, usuario: "Sala Situacional Baruta", accion: "Carga inicial (importado de Excel)" }],
              }));
              setItems(seeded);
              await window.storage.set(PROYECTOS_STORAGE_KEY, JSON.stringify(seeded)).catch(() => {});
            }
          }
        } else if (mounted) {
          setItems(SEED_PROYECTOS);
        }
      } catch (e) {
        if (mounted) setItems(SEED_PROYECTOS);
      } finally {
  ...
  const persist = async (next) => {
    ...
    try {
      if (typeof window !== "undefined" && window.storage) {
        await window.storage.set(PROYECTOS_STORAGE_KEY, JSON.stringify(next));
      }
    } catch (e) {
      // el almacenamiento puede no estar disponible; los datos siguen en memoria
    }
  };
  ...
  const updateProyectoSlot = (idx, value) => setForm((f) => {
    const proyectos = [...f.proyectos];
    proyectos[idx] = value;
    return { ...f, proyectos };
  });

  const onSelectUnidad = (nombre) => {
    const u = UNITS.find((x) => x.nombre === nombre);
    updateForm("unidad", nombre);
    updateForm("tipo", u ? u.tipo : "");
  };

  const resetForm = () => { setForm(emptyProyectoForm()); setEditingId(null); };

  const handleGuardar = async () => {
    if (!form.unidad) { showToast("Selecciona una comuna o circuito"); return; }
    if (!form.responsable.trim()) { showToast("Indica el responsable de la carga"); return; }
    const proyectosLimpios = form.proyectos.map((p) => p.trim()).filter(Boolean);
    if (proyectosLimpios.length === 0) { showToast("Agrega al menos un proyecto"); return; }
    setSaving(true);
    const ahora = new Date().toISOString();
    const anterior = editingId ? items.find((i) => i.id === editingId) : null;
    const historialPrevio = anterior?.historial || [];
    const record = {
      id: editingId || `${Date.now()}`,
      fecha: anterior ? anterior.fecha : ahora,
      actualizado: ahora,
      estado: form.estado,
      ...
      historial: [
        ...historialPrevio,
        { fecha: ahora, usuario: form.responsable.trim(), accion: editingId ? "Editado" : "Creado" },
      ],
    };
    let next;
    if (editingId) {
      next = items.map((i) => (i.id === editingId ? record : i));
    } else {
      next = [record, ...items];
    }
    await persist(next);
    setSaving(false);
    resetForm();
    showToast(editingId ? "Proyecto actualizado" : "Proyecto cargado correctamente");
  };
  ...
  const handleEditar = (item) => {
    ...
    setForm({
      ...
      proyectos: Array.from({ length: NUM_PROYECTOS_SLOTS }, (_, i) => item.proyectos[i] || ""),
      observacion: item.observacion || "",
    });
  };

  const handleEliminar = async (id, unidad) => {
    if (typeof window !== "undefined" && !window.confirm(`¿Eliminar el registro de "${unidad}"? Esta acción no se puede deshacer.`)) return;
  ...
  const toggleOpen = (id) => setOpenSet((prev) => {
    const next = new Set(prev);
    if (next.has(id)) next.delete(id); else next.add(id);
    return next;
  });

  const parroquiasDisponibles = useMemo(() => Array.from(new Set(items.map((i) => i.parroquia))).filter(Boolean).sort(), [items]);

  const filtered = useMemo(() => {
    const q = search.trim().toLowerCase();
    return items.filter((i) => {
      if (estadoFiltro && i.estado !== estadoFiltro) return false;
      if (parroquiaFiltro && i.parroquia !== parroquiaFiltro) return false;
      if (!q) return true;
      const haystack = [i.unidad, i.tipo, i.parroquia, i.estado, i.responsable, i.observacion, ...i.proyectos].join(" ").toLowerCase();
      return haystack.includes(q);
    });
  }, [items, search, estadoFiltro, parroquiaFiltro]);

  const totalProyectos = items.reduce((s, i) => s + i.proyectos.length, 0);
  const unidadesConCarga = new Set(items.map((i) => i.unidad));
  const totalUnidadesConCarga = unidadesConCarga.size;
  const unidadesFaltantes = UNITS.filter((u) => !unidadesConCarga.has(u.nombre));
  const coberturaPct = Math.round((totalUnidadesConCarga / UNITS.length) * 100);

  const conteoEstados = useMemo(() => {
    const base = { "SE CONFIRMA": 0, "SE MODIFICO": 0, "PENDIENTE": 0, "POR REVISAR": 0 };
    items.forEach((i) => { base[i.estado] = (base[i.estado] || 0) + 1; });
    return base;
  }, [items]);

  /* -------- Exportar CSV (compatible Excel) -------- */
  const generarCSV = () => {
    if (items.length === 0) { showToast("No hay proyectos cargados para exportar"); return; }
    const headers = ["ESTADO", "PARROQUIA", "COMUNA/CIRCUITO", "TIPO", "RESPONSABLE", ...Array.from({ length: NUM_PROYECTOS_SLOTS }, (_, i) => `PROYECTO ${i + 1}`), "OBSERVACION", "ULTIMA_ACTUALIZACION"];
    const esc = (v) => `"${String(v ?? "").replace(/"/g, '""')}"`;
    const rows = items.map((i) => [
      i.estado, i.parroquia, i.unidad, i.tipo, i.responsable,
      ...Array.from({ length: NUM_PROYECTOS_SLOTS }, (_, k) => i.proyectos[k] || ""),
      i.observacion, fmtFechaCorta(i.actualizado || i.fecha),
    ].map(esc).join(";"));
    ...
    a.href = url;
    a.download = `proyectos_postulados_baruta_${new Date().toISOString().slice(0, 10)}.csv`;
    a.click();
  ...
  const generarReporte = () => {
    if (items.length === 0) { showToast("No hay proyectos cargados para reportar"); return; }
    const fechaReporte = new Date().toLocaleString("es-VE", { dateStyle: "long", timeStyle: "short" });
    const folio = `RPT-PROY-BRT-${new Date().toISOString().slice(0, 10).replace(/-/g, "")}-${String(Date.now()).slice(-4)}`;
    const responsables = Array.from(new Set(items.map((i) => i.responsable).filter(Boolean)));

    // Agrupar por parroquia -> unidades
    const porParroquia = {};
    items.forEach((i) => {
      if (!porParroquia[i.parroquia]) porParroquia[i.parroquia] = [];
      porParroquia[i.parroquia].push(i);
    });

    const estadoColorPdf = (e) => (ESTADO_STYLE[e] ? ESTADO_STYLE[e].pdf : "#475569");

    const bloquesParroquia = Object.entries(porParroquia).map(([parroquia, regs]) => {
      const subtotalProyectos = regs.reduce((s, r) => s + r.proyectos.length, 0);
      const filas = regs.map((i, idx) => `
        <tr>
          <td>${idx + 1}</td>
          <td>${i.tipo || "-"}</td>
          <td style="font-weight:600;">${i.unidad}</td>
          <td><span class="badge" style="background:${estadoColorPdf(i.estado)}20;color:${estadoColorPdf(i.estado)};">${i.estado}</span></td>
          <td>${i.responsable || "-"}</td>
          <td><ol>${i.proyectos.map((p) => `<li>${p}</li>`).join("")}</ol></td>
          <td>${i.observacion || "-"}</td>
        </tr>`).join("");
      return `
        <div class="bloque-parroquia">
          <div class="parroquia-header">
            <span>${parroquia}</span>
            <span class="parroquia-sub">${regs.length} unidad(es) · ${subtotalProyectos} proyecto(s)</span>
          </div>
          <table>
            <thead><tr><th>#</th><th>Tipo</th><th>Comuna / Circuito</th><th>Estado</th><th>Responsable</th><th>Proyectos</th><th>Observación</th></tr></thead>
            <tbody>${filas}</tbody>
          </table>
        </div>`;
    }).join("");

    // Donut de estados vía conic-gradient
    const totalReg = items.length;
    const segColores = { "SE CONFIRMA": "#059669", "SE MODIFICO": "#B45309", "PENDIENTE": "#B91C1C", "POR REVISAR": "#64748B" };
    let acc = 0;
    const stops = Object.entries(conteoEstados).filter(([, v]) => v > 0).map(([k, v]) => {
      const pct = (v / totalReg) * 100;
      const from = acc; acc += pct;
      return `${segColores[k]} ${from}% ${acc}%`;
    }).join(", ");
    const leyenda = Object.entries(conteoEstados).filter(([, v]) => v > 0).map(([k, v]) =>
      `<div class="leyenda-item"><span class="dot" style="background:${segColores[k]}"></span>${k} — ${v} (${Math.round((v / totalReg) * 100)}%)</div>`
    ).join("");

    const html = `<!DOCTYPE html>
<html lang="es"><head><meta charset="utf-8" />
<title>Reporte de Proyectos Postulados - Baruta - ${folio}</title>
<style>
  @page { margin: 20mm 14mm; }
  * { box-sizing: border-box; }
  body { font-family: 'Helvetica Neue', Arial, sans-serif; color:#1a1a2e; margin: 0; padding: 28px 34px; font-size: 12.5px; }
  .accent-bar { height: 5px; width:100%; background: linear-gradient(90deg,#FCD116 0 33.3%, #003DA5 33.3% 66.6%, #CF142B 66.6% 100%); border-radius: 3px; margin-bottom: 18px; }
  .encabezado { display:flex; align-items:center; justify-content:space-between; border-bottom: 2px solid #1e3a8a; padding-bottom: 14px; margin-bottom: 18px; }
  .encabezado-izq { display:flex; align-items:center; gap: 14px; }
  .emblema { width:52px; height:52px; flex-shrink:0; }
  h1 { font-size: 18px; margin: 0 0 2px; color:#1e3a8a; letter-spacing:.2px; }
  h2 { font-size: 12px; font-weight: 500; color:#555; margin:0; }
  .folio-box { text-align:right; font-size: 10.5px; color:#475569; line-height:1.5; }
  .folio-box b { color:#1e3a8a; }
  .resumen-wrap { display:flex; gap:28px; align-items:center; margin: 18px 0 22px; padding: 14px 18px; background:#f8fafc; border-radius: 10px; border: 1px solid #e2e8f0; }
  .kpis { display:flex; gap:20px; flex:1; }
  .kpi b { display:block; font-size:20px; color:#1e3a8a; }
  .kpi span { font-size: 10.5px; color:#64748b; }
  .donut { width:92px; height:92px; border-radius:50%; background: conic-gradient(${stops}); position:relative; flex-shrink:0; }
  .donut::after { content:""; position:absolute; inset:16px; background:#fff; border-radius:50%; }
  .leyenda { font-size: 10.5px; color:#334155; display:flex; flex-direction:column; gap:4px; }
  .leyenda-item { display:flex; align-items:center; gap:6px; }
  .dot { width:8px; height:8px; border-radius:50%; display:inline-block; }
  .parroquia-header { background:#1e3a8a; color:#fff; padding:7px 12px; font-size:11.5px; font-weight:600; letter-spacing:.3px; display:flex; justify-content:space-between; border-radius: 6px 6px 0 0; margin-top: 18px; }
  .parroquia-sub { font-weight:400; opacity:.85; font-size: 10.5px; }
  table { border-collapse: collapse; width: 100%; font-size: 11px; }
  th, td { padding:7px 8px; border:1px solid #e2e8f0; vertical-align:top; text-align:left; }
  thead th { background:#eef2ff; color:#1e3a8a; font-size:10.5px; text-transform:uppercase; letter-spacing:.3px; }
  ol { margin:0; padding-left:16px; }
  .badge { padding:2px 8px; border-radius:999px; font-size:10px; font-weight:700; white-space:nowrap; }
  .firmas { display:flex; justify-content:space-between; margin-top: 46px; padding-top: 10px; }
  .firma { width: 28%; text-align:center; font-size: 10.5px; color:#334155; }
  .firma .linea { border-top: 1px solid #94a3b8; margin-bottom: 6px; padding-top: 34px; }
  .pie { margin-top: 26px; font-size: 9.5px; color:#94a3b8; text-align:center; border-top: 1px solid #e2e8f0; padding-top: 8px; }
  .toolbar { margin-bottom:16px; display:flex; gap:8px; }
  .toolbar button { padding:8px 14px; border-radius:6px; border:none; cursor:pointer; font-size:12.5px; font-weight:600; }
  @media print { .toolbar { display:none; } .bloque-parroquia { page-break-inside: avoid; } }
</style></head>
<body>
  <div class="toolbar">
    <button onclick="window.print()" style="background:#1e3a8a;color:#fff;">Imprimir / Guardar como PDF</button>
  </div>
  <div class="accent-bar"></div>
  <div class="encabezado">
    <div class="encabezado-izq">
      <svg class="emblema" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <path d="M32 3 L58 14 V32 C58 46 47 56 32 61 C17 56 6 46 6 32 V14 Z" fill="#1e3a8a" stroke="#FCD116" stroke-width="2"/>
        <circle cx="32" cy="28" r="11" fill="#FCD116"/>
        <path d="M16 46 C22 40 42 40 48 46 C42 52 22 52 16 46 Z" fill="#CF142B"/>
      </svg>
      <div>
        <h1>Reporte de Proyectos Postulados</h1>
        <h2>Comunas y Circuitos Comunales · Municipio Baruta · Consulta Popular Julio 2026</h2>
      </div>
    </div>
    <div class="folio-box">
      <div><b>Folio:</b> ${folio}</div>
      <div><b>Generado:</b> ${fechaReporte}</div>
      <div><b>Cobertura:</b> ${totalUnidadesConCarga}/${UNITS.length} unidades (${coberturaPct}%)</div>
    </div>
  </div>
  ...
  <div class="resumen-wrap">
    ...
    <div class="kpis">
      <div class="kpi"><b>${items.length}</b><span>Registros</span></div>
      <div class="kpi"><b>${totalUnidadesConCarga}</b><span>Comunas/Circuitos</span></div>
      <div class="kpi"><b>${totalProyectos}</b><span>Proyectos totales</span></div>
    </div>
  </div>
  ...
  <div class="firmas">
    <div class="firma"><div class="linea">Elaborado por${responsables.length === 1 ? `<br/><b>${responsables[0]}</b>` : ""}</div></div>
    <div class="firma"><div class="linea">Revisado por</div></div>
    <div class="firma"><div class="linea">Aprobado por</div></div>
  </div>

  <div class="pie">Documento de uso interno · Alcaldía del Municipio Baruta · Centro de Inteligencia Electoral · Folio ${folio}</div>
</body></html>`;
    ...
    if (w) {
      ...
      const a = document.createElement("a");
      a.href = url;
      a.download = `reporte_proyectos_baruta_${folio}.html`;
      a.click();
      URL.revokeObjectURL(url);
    }
  ...
  const unidadOptions = UNITS.map((u) => u.nombre);

  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <KpiCard label="Comunas/Circuitos con carga" value={totalUnidadesConCarga} sub={`De ${UNITS.length} unidades territoriales · ${coberturaPct}% cobertura`} icon={MapPinned} color={COLORS.blue} progress={coberturaPct} />
        <KpiCard label="Registros cargados" value={items.length} sub="Postulaciones de proyectos" icon={ClipboardList} color="#0891B2" progress={100} />
        <KpiCard label="Proyectos totales" value={totalProyectos} sub="Sumatoria de todos los registros" icon={Layers} color={COLORS.verde} progress={100} />
      </div>

      {/* ALERTA DE COBERTURA */}
      {unidadesFaltantes.length > 0 && (
        <div className="rounded-xl p-4" style={{ background: "rgba(251,191,36,0.08)", border: "1px solid rgba(251,191,36,0.3)" }}>
          <button onClick={() => setShowFaltantes((v) => !v)} className="w-full flex items-center justify-between gap-3 text-left">
            <span className="flex items-center gap-2 text-xs font-semibold" style={{ color: "#FBBF24" }}>
              <AlertTriangle size={14} /> {unidadesFaltantes.length} comuna(s)/circuito(s) aún sin proyectos cargados
            </span>
            <ChevronDown size={14} className="transition-transform duration-200" style={{ color: "#FBBF24", transform: showFaltantes ? "rotate(180deg)" : "none" }} />
          </button>
          {showFaltantes && (
            <div className="mt-3 flex flex-wrap gap-1.5">
              {unidadesFaltantes.map((u) => (
                <span key={u.nombre} className="text-[10px] rounded-full px-2.5 py-1" style={{ background: T.input, color: T.textSecondary, border: `1px solid ${T.border}` }}>{u.nombre}</span>
              ))}
            </div>
          )}
        </div>
      ...
      <Panel>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold tracking-wide flex items-center gap-2" style={{ color: T.textPrimary }}>
            ...
            {editingId ? "EDITAR PROYECTO POSTULADO" : "CARGAR PROYECTOS POR COMUNA / CIRCUITO"}
          </h3>
          {editingId && (
            <button onClick={resetForm} className="text-[11px] rounded-full px-2.5 py-1 flex items-center gap-1" style={{ color: T.textMuted, background: T.input, border: `1px solid ${T.border}` }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3">
          <div>
            <label className="text-[11px] font-medium block mb-1" style={{ color: T.textMuted }}>Comuna / Circuito comunal</label>
            <SelectPill value={form.unidad} onChange={onSelectUnidad} options={unidadOptions} placeholder="Selecciona unidad territorial" fullWidth />
          </div>
          <div>
            <label className="text-[11px] font-medium block mb-1" style={{ color: T.textMuted }}>Parroquia</label>
            <input value={form.parroquia} onChange={(e) => updateForm("parroquia", e.target.value)}
              className="w-full rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
              style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textPrimary }} />
          </div>
          <div>
            <label className="text-[11px] font-medium block mb-1" style={{ color: T.textMuted }}>Tipo</label>
            <input value={form.tipo} disabled placeholder="Se autocompleta"
              className="w-full rounded-lg px-3 py-2 text-sm opacity-60"
              style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textPrimary }} />
          </div>
          <div>
            <label className="text-[11px] font-medium block mb-1" style={{ color: T.textMuted }}>Estado</label>
            <SelectPill value={form.estado} onChange={(v) => updateForm("estado", v)} options={ESTADOS_PROYECTO} fullWidth />
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
          <div>
            <label className="text-[11px] font-medium block mb-1" style={{ color: T.textMuted }}>Responsable de la carga</label>
            <input value={form.responsable} onChange={(e) => updateForm("responsable", e.target.value)}
              placeholder="Nombre de quien registra la información"
              className="w-full rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
              style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textPrimary }} />
          </div>
        </div>

        <label className="text-[11px] font-medium block mb-1.5" style={{ color: T.textMuted }}>Proyectos (1 al 7)</label>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-3">
          {form.proyectos.map((p, idx) => (
            <input key={idx} value={p} onChange={(e) => updateProyectoSlot(idx, e.target.value)}
              placeholder={`Proyecto ${idx + 1} (ej: 2T DOTACIÓN DE CILINDROS DE GAS)`}
              className="w-full rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
              style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textPrimary }} />
          ))}
        </div>

        <label className="text-[11px] font-medium block mb-1" style={{ color: T.textMuted }}>Observación / Incidencia</label>
        <textarea value={form.observacion} onChange={(e) => updateForm("observacion", e.target.value)} rows={2}
          placeholder="Observaciones adicionales sobre la postulación..."
          className="w-full rounded-lg px-3 py-2 text-sm mb-4 focus:outline-none focus:ring-1 focus:ring-blue-500"
          style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textPrimary }} />

        <div className="flex flex-wrap items-center gap-2">
          <button onClick={handleGuardar} disabled={saving}
            className="flex items-center gap-1.5 text-xs font-semibold rounded-lg px-4 py-2.5 transition-all duration-200 disabled:opacity-60"
            style={{ background: "#2563EB", color: "#fff" }}>
            {saving ? <Loader2 size={14} className="animate-spin" /> : (editingId ? <Save size={14} /> : <Plus size={14} />)}
            {editingId ? "Guardar cambios" : "Cargar proyecto"}
          </button>

          <div className="flex items-center gap-2 ml-auto">
            <button onClick={generarCSV}
              className="flex items-center gap-1.5 text-xs font-semibold rounded-lg px-4 py-2.5 transition-all duration-200"
              style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textSecondary }}>
              <FileDown size={14} /> Exportar Excel (CSV)
            </button>
            <button onClick={generarReporte}
              className="flex items-center gap-1.5 text-xs font-semibold rounded-lg px-4 py-2.5 transition-all duration-200"
              style={{ background: "linear-gradient(135deg,#059669,#047857)", color: "#fff" }}>
              <Printer size={14} /> Generar reporte de inmediato
            </button>
          </div>

          {toast && (
            <span className="text-[11px] font-medium rounded-full px-3 py-1.5" style={{ color: "#34D399", background: "rgba(16,185,129,0.1)" }}>
              {toast}
            </span>
          )}
        </div>
      ...
      <Panel noPadding className="overflow-hidden">
        <div className="p-5 flex flex-wrap items-center gap-3" style={{ borderBottom: `1px solid ${T.border}` }}>
          <div className="mr-auto">
            <h3 className="text-sm font-semibold tracking-wide flex items-center gap-2" style={{ color: T.textPrimary }}>
              <TableIcon size={16} className="text-blue-400" /> PROYECTOS CARGADOS
            </h3>
            <p className="text-xs mt-0.5" style={{ color: T.textMuted }}>{filtered.length} de {items.length} registro(s)</p>
          </div>
          <SelectPill value={estadoFiltro} onChange={setEstadoFiltro} options={ESTADOS_PROYECTO} placeholder="Todos los estados" />
          <SelectPill value={parroquiaFiltro} onChange={setParroquiaFiltro} options={parroquiasDisponibles} placeholder="Todas las parroquias" />
          <div className="relative">
            <Search size={14} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: T.textMuted }} />
            <input
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              placeholder="Buscar comuna, circuito o proyecto..."
              className="rounded-lg pl-9 pr-3 py-2 text-sm w-56 focus:outline-none focus:ring-1 focus:ring-blue-500"
              style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textPrimary }}
            />
          </div>
        </div>
        ...
        {loading ? (
          <p className="text-center text-xs py-10 flex items-center justify-center gap-2" style={{ color: T.textMuted }}>
            <Loader2 size={14} className="animate-spin" /> Cargando proyectos guardados...
          </p>
        ) : filtered.length === 0 ? (
          <p className="text-center text-xs py-10" style={{ color: T.textMuted }}>
            Ningún registro coincide con los filtros, o aún no hay proyectos cargados.
          </p>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr style={{ borderBottom: `1px solid ${T.border}` }}>
                  {["", "Comuna / Circuito", "Tipo", "Parroquia", "Estado", "Responsable", "Proyectos", "Actualizado", ""].map((h, i) => (
                    <th key={i} className="text-left font-semibold uppercase tracking-wide px-3 py-2.5 whitespace-nowrap" style={{ color: T.textMuted, fontSize: "10px" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {filtered.map((item) => {
                  ...
                  const st = ESTADO_STYLE[item.estado] || ESTADO_STYLE["POR REVISAR"];
                  return (
                    <React.Fragment key={item.id}>
                      <tr className="transition-colors" style={{ borderBottom: `1px solid ${T.border}`, cursor: "pointer" }} onClick={() => toggleOpen(item.id)}>
                        <td className="px-3 py-2.5">
                          <ChevronDown size={13} style={{ color: T.textMuted, transition: "transform .2s", transform: isOpen ? "rotate(180deg)" : "none" }} />
                        </td>
                        <td className="px-3 py-2.5 font-semibold whitespace-nowrap" style={{ color: T.textPrimary }}>{item.unidad}</td>
                        <td className="px-3 py-2.5 whitespace-nowrap" style={{ color: T.textSecondary }}>{item.tipo || "-"}</td>
                        <td className="px-3 py-2.5 whitespace-nowrap" style={{ color: T.textSecondary }}>{item.parroquia}</td>
                        <td className="px-3 py-2.5">
                          <span className="text-[10px] font-semibold uppercase tracking-wide rounded-full px-2.5 py-1 whitespace-nowrap" style={{ color: st.color, background: st.bg }}>{item.estado}</span>
                        </td>
                        <td className="px-3 py-2.5 whitespace-nowrap" style={{ color: T.textSecondary }}>{item.responsable || "-"}</td>
                        <td className="px-3 py-2.5 whitespace-nowrap" style={{ color: T.textSecondary }}>{item.proyectos.length}</td>
                        <td className="px-3 py-2.5 whitespace-nowrap" style={{ color: T.textMuted }}>{fmtFechaCorta(item.actualizado || item.fecha)}</td>
                        <td className="px-3 py-2.5" onClick={(e) => e.stopPropagation()}>
                          <div className="flex items-center gap-1.5">
                            <button onClick={() => handleEditar(item)} className="h-7 w-7 flex items-center justify-center rounded-lg" style={{ background: T.input, border: `1px solid ${T.border}`, color: T.textSecondary }} title="Editar">
                              <Pencil size={12} />
                            </button>
                            <button onClick={() => handleEliminar(item.id, item.unidad)} className="h-7 w-7 flex items-center justify-center rounded-lg" style={{ background: "rgba(239,68,68,0.08)", color: "#F87171" }} title="Eliminar">
                              <Trash2 size={12} />
                            </button>
                          </div>
                        </td>
                        ...
                        <tr style={{ borderBottom: `1px solid ${T.border}`, background: T.panelAlt }}>
                          ...
                          <td colSpan={8} className="px-3 py-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                <p className="text-[10px] font-semibold uppercase tracking-wide mb-1.5" style={{ color: T.textMuted }}>Proyectos postulados</p>
                                <ol className="text-xs list-decimal list-inside space-y-0.5" style={{ color: T.textSecondary }}>
                                  {item.proyectos.map((p, i) => <li key={i}>{p}</li>)}
                                </ol>
                                {item.observacion && (
                                  <p className="text-[11px] mt-2 italic" style={{ color: T.textMuted }}>Obs: {item.observacion}</p>
                                )}
                              </div>
                              <div>
                                <p className="text-[10px] font-semibold uppercase tracking-wide mb-1.5" style={{ color: T.textMuted }}>Historial de cambios</p>
                                <div className="space-y-1.5">
                                  {(item.historial || []).slice().reverse().map((h, i) => (
                                    <div key={i} className="text-[11px] flex items-center gap-2" style={{ color: T.textSecondary }}>
                                      <span className="h-1.5 w-1.5 rounded-full flex-shrink-0" style={{ background: "#60A5FA" }}></span>
                                      <span style={{ color: T.textMuted }}>{fmtFechaCorta(h.fecha)}</span>
                                      <span>· {h.accion}</span>
                                      <span style={{ color: T.textMuted }}>· {h.usuario}</span>
                                    </div>
                                  ))}
                                </div>
                              </div>
...
const TABS = [
  ...
  { id: "proyectos", label: "Proyectos Comunas/Circuitos", Icon: ClipboardList },
];
      ...
      <div className="min-h-screen w-full transition-colors duration-300" style={{ background: T.bg, color: T.textPrimary, fontFamily: "'Inter', ui-sans-serif, system-ui" }}>
        ...
        <div className="flex">
          ...
          <aside className="hidden md:flex flex-col w-60 shrink-0 min-h-screen p-4" style={{ background: T.sidebar, borderRight: `1px solid ${T.border}` }}>
            <div className="h-1 w-full rounded-full mb-4" style={{ background: "linear-gradient(90deg,#FCD116 0 33.3%, #003DA5 33.3% 66.6%, #CF142B 66.6% 100%)" }} />
            <div className="flex items-center gap-2.5 px-2 pb-6">
              <svg width="34" height="34" viewBox="0 0 64 64" className="flex-shrink-0">
                <path d="M32 3 L58 14 V32 C58 46 47 56 32 61 C17 56 6 46 6 32 V14 Z" fill="#1e3a8a" stroke="#FCD116" strokeWidth="2"/>
                <circle cx="32" cy="28" r="11" fill="#FCD116"/>
                <path d="M16 46 C22 40 42 40 48 46 C42 52 22 52 16 46 Z" fill="#CF142B"/>
              </svg>
              <div>
            ...
            <div className="mt-auto pt-6" style={{ borderTop: `1px solid ${T.border}` }}>
              ...
              <p className="text-[9px] leading-relaxed px-2 mt-3 font-medium tracking-wide" style={{ color: T.textMuted, opacity: 0.7 }}>
                ALCALDÍA DEL MUNICIPIO BARUTA · USO INTERNO
              </p>
            </div>
          </aside>
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="h-[3px] w-full" style={{ background: "linear-gradient(90deg,#FCD116 0 33.3%, #003DA5 33.3% 66.6%, #CF142B 66.6% 100%)" }} />
